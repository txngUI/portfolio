...
export default function HeroVideoDialog({
  ...
  return (
    <div style={{ width: "400px"}} className={cn("relative", className)}>
      <div
      ...
      >
        <img
          ...
          width={1920}
          height={1080}
          className="w-full transition-all duration-200 group-hover:brightness-[0.8] ease-out rounded-3xl shadow-lg border"
        />
        <div className="absolute inset-0 flex items-center justify-center group-hover:scale-100 scale-[0.9] transition-all duration-200 ease-out rounded-3xl">
      ...
      <AnimatePresence>
        {isVideoOpen && (
          <motion.div
            ...
            exit={{ opacity: 0 }}
            className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-md rounded-3xl"
          >
            <motion.div
              {...selectedAnimation}
