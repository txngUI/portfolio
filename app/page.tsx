...
export default function Home() {
  ...
  return (
    <div className="relative">
      <div className="bg-[#1E3A8A] w-full h-1/2 text-center text-white py-4 z-10">RECHERCHE ACTIVEMENT UNE ALTERNANCE POUR MON MASTERE EN DEVELOPPEMENT FULLSTACK SUR RENNES POUR SEPTEMBRE PROCHAIN</div>
